...
extern double BB_RMSD(int n, double (*motif1)[3],double (*motif2)[3], double cutoff);
extern double RMSDshort(int n, double (*motif1)[3],double (*motif2)[3], double cutoff);
extern double SqDisshort(int n, double (*motif1)[3],double (*motif2)[3], double cutoff);
extern double RMSDshortALL(int n, double (*motif1)[3],double (*motif2)[3], double cutoff);
...
//extern double dot(double u[3],double v[3]);
